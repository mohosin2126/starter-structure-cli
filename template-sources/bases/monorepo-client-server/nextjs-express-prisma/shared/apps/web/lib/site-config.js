export const siteConfig = {
  ...
  brandMark: "N",
  tagline:
    "A JavaScript-first Next.js starter with Tailwind CSS, a sharp landing page shell, and a project structure that stays readable as the app grows.",
  navItems: [
  ...
  previewCards: [
    ...
    },
    {
      ...
      badge: "App Router",
      copy: "Pages, components, config, and public assets live in the places most teams expect."
    }
  ],
  features: [
    {
