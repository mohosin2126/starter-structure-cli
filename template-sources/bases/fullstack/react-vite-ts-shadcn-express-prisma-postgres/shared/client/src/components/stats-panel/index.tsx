...
const summary = [
  { label: "Auth routes", value: "4 wired" },
  { label: "Starter modules", value: "Enterprise layer ready" },
  { label: "Database target", value: "PostgreSQL" }
] as const;
    ...
    <aside className="rounded-[1.75rem] border border-[var(--border)] bg-slate-950 p-6 text-slate-50">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <h2 className="mt-3 text-2xl font-semibold">Fullstack blocks ready for the next screen.</h2>
        </div>
