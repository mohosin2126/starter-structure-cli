export function CalloutStrip() {
  return (
    <section className="py-16 md:py-24" id="cta">
      <div className="shell">
        <div className="overflow-hidden rounded-[2rem] border border-[var(--color-line)] bg-[linear-gradient(135deg,_rgba(139,242,204,0.12),_rgba(255,211,110,0.08)_55%,_rgba(255,255,255,0.03))] p-8 md:p-12">
