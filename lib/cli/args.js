...
export function parseArgs(argv) {
  ...
  for (let index = 0; index < argv.length; index += 1) {
    ...
    if (flag === "--template-info" || flag === "--info") {
      args.templateInfoRef = value;
      continue;
    }
...
Options:
  ...
  --json                     Print JSON for --list, --doctor, --template-info, or --dry-run
  ...
  --template-info, --info    Show details for one template slug or category/slug
