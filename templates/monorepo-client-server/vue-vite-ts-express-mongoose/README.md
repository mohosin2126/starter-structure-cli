...
Starter scaffold for `monorepo-client-server/vue-vite-ts-express-mongoose`.
...
1. Replace placeholder files with production starter code for Vue + Vite + TypeScript + Express + Mongoose client/server monorepo.
