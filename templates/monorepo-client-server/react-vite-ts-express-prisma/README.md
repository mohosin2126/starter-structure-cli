...
Starter scaffold for `monorepo-client-server/react-vite-ts-express-prisma`.
...
1. Replace placeholder files with production starter code for React + Vite + TypeScript + Express + Prisma client/server monorepo.
