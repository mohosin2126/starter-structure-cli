...
Starter scaffold for `fullstack/nextjs-tailwind-mongoose-mongodb`.
...
1. Replace placeholder files with production starter code for Next.js + Tailwind + Mongoose + MongoDB fullstack app.
