...
Starter scaffold for `fullstack/nextjs-tailwind-prisma-postgres`.
...
1. Replace placeholder files with production starter code for Next.js + Tailwind + Prisma + PostgreSQL fullstack app.
