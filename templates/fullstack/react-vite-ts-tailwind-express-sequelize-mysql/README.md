...
Starter scaffold for `fullstack/react-vite-ts-tailwind-express-sequelize-mysql`.
...
1. Replace placeholder files with production starter code for React + Vite + TypeScript + Tailwind + Express + Sequelize + MySQL fullstack app.
