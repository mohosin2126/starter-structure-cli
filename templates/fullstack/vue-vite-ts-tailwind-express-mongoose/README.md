...
Starter scaffold for `fullstack/vue-vite-ts-tailwind-express-mongoose`.
...
1. Replace placeholder files with production starter code for Vue + Vite + TypeScript + Tailwind + Express + Mongoose fullstack app.
