...
Starter scaffold for `fullstack/react-vite-ts-tailwind-express-mongoose`.
...
1. Replace placeholder files with production starter code for React + Vite + TypeScript + Tailwind + Express + Mongoose fullstack app.
