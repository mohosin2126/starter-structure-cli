...
Starter scaffold for `fullstack/nextjs-tailwind-prisma-mysql`.
...
1. Replace placeholder files with production starter code for Next.js + Tailwind + Prisma + MySQL fullstack app.
